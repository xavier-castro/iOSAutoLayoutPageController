...
//  Edited and followed along by Xavier Castro 1/27/19.
...
class ViewController: UIViewController {
    ...
    let descriptionTextView: UITextView = {
        ...
        textView.isEditable = false // Removes keyboard from popping up
